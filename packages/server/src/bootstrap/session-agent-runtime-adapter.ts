...
import {
  ...
  getSessionMessageCountFromDbWithProfile,
  getUsageStatsFromDb,
...
configureSessionAgentRuntime({
  ...
  getHermesSessionMessageCountForProfile: getSessionMessageCountFromDbWithProfile,
  getHermesAncestorSessionRows: getAncestorSessionRowsFromDb,
