...
export default {
  ...
  login: {
    ...
    orDivider: '또는',
    ssoLogin: 'SSO로 로그인',
    ssoFailed: 'SSO 로그인에 실패했습니다. 다시 시도해 주세요.',
    ssoErrors: {
      invite_unavailable: '이 초대 링크는 더 이상 사용할 수 없습니다.',
      sso_unavailable: '이 서버에는 SSO가 구성되어 있지 않습니다.',
      sso_state_invalid: '로그인 세션이 만료되었습니다. 다시 시도해 주세요.',
      sso_failed: 'SSO 로그인에 실패했습니다. 다시 시도해 주세요.',
      access_denied: '인증이 거부되었습니다.',
  ...
  invite: {
    title: 'Hermes Studio 참여',
    description: '프로필에 초대되었습니다',
    confirmPasswordPlaceholder: '비밀번호 확인',
    submit: '계정 만들고 참여하기',
    joinFailed: '초대 링크로 참여하지 못했습니다',
    joinWithCurrentAccount: '현재 계정으로 참여',
    invalid: '이 초대 링크는 유효하지 않습니다',
    unavailableTitle: '초대 불가',
    unavailable: '이 초대 링크를 사용할 수 없습니다({status})',
    backToLogin: '로그인으로 돌아가기',
  },

  invites: {
    title: '프로필 초대 링크',
    description: '프로필 접근 권한을 부여하는 초대 링크를 만듭니다. 링크로 가입한 계정은 기본 사용자 역할을 받습니다.',
    create: '초대 만들기',
    createSuccess: '초대가 생성되었습니다',
    revoke: '해지',
    revokeConfirm: '이 초대를 해지하시겠습니까?',
    revokeSuccess: '초대가 해지되었습니다',
    copy: '링크 복사',
    copied: '링크가 복사되었습니다',
    copyFailed: '복사 실패',
    loadFailed: '초대 목록을 불러오지 못했습니다',
    profile: '프로필',
    profileRequired: '프로필을 선택하세요',
    profilePlaceholder: '프로필 선택',
    expiresInDays: '만료 기간',
    daysUnit: '일',
    neverExpires: '만료 없음',
    expires: '만료일',
    ...
    maxUses: '최대 사용 횟수',
    maxUsesHint: '0 = 무제한',
    formHint: '0일은 만료 없음, 최대 사용 횟수 0은 무제한입니다.',
    statusLabel: '상태',
    linkLabel: '초대 링크',
    status: {
      active: '활성',
  ...
  chat: {
    ...
    continueInWebUiTitle: 'Web UI에서 계속하시겠습니까?',
    continueInWebUiWarning: '이 기록에서 별도의 Web 대화를 만듭니다. 새 대화의 메시지는 {source}로 다시 전송되지 않습니다. {source}의 새 메시지는 원래 대화에서 계속됩니다.',
    createWebConversation: 'Web 대화 만들기',
    continueInWebUiFailed: 'Web 대화를 만들지 못했습니다',
