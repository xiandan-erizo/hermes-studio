...
export default {
  ...
  invite: {
    title: 'Join Hermes Studio',
    description: 'You have been invited to the profile',
    confirmPasswordPlaceholder: 'Confirm password',
    submit: 'Create account & join',
    joinFailed: 'Failed to join with this invite',
    joinWithCurrentAccount: 'Join with my current account',
    invalid: 'This invitation is invalid',
    unavailableTitle: 'Invitation unavailable',
    unavailable: 'This invitation is not available ({status})',
    backToLogin: 'Back to login',
  },

  invites: {
    title: 'Profile Invitations',
    description: 'Create invitation links that grant access to a profile. New accounts join with the default user role.',
    ...
    profile: 'Profile',
    profileRequired: 'Select a profile',
    ...
    formHint: '0 days = never expires. Max uses 0 = unlimited.',
    statusLabel: 'Status',
  ...
  sidebar: {
    ...
    externalIdentities: 'Channel Identities',
    channels: 'Channels',
  ...
  chat: {
    ...
    continueInWebUiTitle: 'Continue in Web UI?',
    continueInWebUiWarning: 'A separate Web conversation will be created from this history. Messages sent in the new Web conversation will not be sent back to {source}. New messages in {source} will continue in the original conversation.',
    createWebConversation: 'Create Web conversation',
    continueInWebUiFailed: 'Failed to create Web conversation',
  ...
  // Skills
  externalIdentities: {
    title: 'Channel Identity Mapping',
    subtitle: 'Map feishu / dingtalk channel users to Studio accounts. Mapped users can read their own channel history on the web.',
    mappingsTitle: 'Mappings',
    candidatesTitle: 'Unmapped Candidates',
    candidatesHint: 'Unmapped identities seen in Hermes channel sessions, sorted by session count. Bind one to grant that user read access.',
    refresh: 'Refresh',
    colSource: 'Channel',
    ...
    emptyCandidates: 'No unmapped candidates',
    loadFailed: 'Failed to load',
    bindSuccess: 'Mapping created',
    bindFailed: 'Failed to create mapping',
    deleteSuccess: 'Mapping deleted',
    deleteFailed: 'Failed to delete mapping',
  },
  marketplace: {
    title: 'Plugin Marketplace',
    subtitle: 'Browse git skill plugin sources and install skills into the active profile',
    ...
    deleteSourceTitle: 'Remove marketplace source',
    deleteSourceConfirm: 'Remove source "{name}"? Its local cache will be deleted. Installed skills stay installed.',
    sourceName: 'Source name',
    sourceNamePlaceholder: 'e.g. hose-skills',
    sourceUrl: 'Git SSH URL',
    sshOnlyHint: 'Only git SSH URLs are supported, e.g. git@git.ekuaibao.com:ai-learning/hose-skills.git',
    created: 'Source added',
    createdSyncFailed: 'Source added, but the initial sync failed: {error}',
    sourceDeleted: 'Source removed',
    loadFailed: 'Failed to load marketplace: {error}',
    empty: 'No marketplace sources configured yet.',
    emptyAdmin: 'No marketplace sources configured yet. Add a git SSH source to browse its plugins.',
    noPlugins: 'No plugins found',
    skillCount: '{n} skill(s)',
    installed: 'Installed',
    installedAt: 'Installed · updated {time}',
    modified: 'Modified locally',
    install: 'Install',
    installSuccess: 'Skill "{name}" installed',
    uninstall: 'Uninstall',
    uninstallConfirm: 'Uninstall skill "{name}"? Its directory will be removed from the active profile.',
    uninstallSuccess: 'Skill "{name}" uninstalled',
    lastSynced: 'Last synced',
    syncFailed: 'Last sync failed',
    defaultPrompt: 'Suggested prompts',
    pluginMissing: 'Plugin not found in this source',
  },
  skills: {
    title: 'Skills',
