...
export default {
  ...
  login: {
    ...
    orDivider: '或',
    ssoLogin: '使用 SSO 登入',
    ssoFailed: '單點登入失敗，請重試。',
    ssoErrors: {
      invite_unavailable: '該邀請已失效。',
      sso_unavailable: '伺服器未設定單點登入。',
      sso_state_invalid: '登入工作階段已過期，請重試。',
      sso_failed: '單點登入失敗，請重試。',
      access_denied: '授權被拒絕。',
      account_disabled: '你的帳號已被停用。',
    },
  ...
  invite: {
    title: '加入 Hermes Studio',
    description: '你被邀請加入設定檔',
    confirmPasswordPlaceholder: '確認密碼',
    submit: '建立帳號並加入',
    joinFailed: '加入失敗',
    joinWithCurrentAccount: '使用目前帳號加入',
    invalid: '邀請連結無效',
    unavailableTitle: '邀請不可用',
    unavailable: '該邀請目前不可用（{status}）',
    backToLogin: '返回登入',
  },

  invites: {
    title: '設定檔邀請連結',
    description: '建立可分享的邀請連結，授予某個設定檔的存取權限。透過連結註冊的帳號預設為普通用戶角色。',
    create: '建立邀請',
    createSuccess: '邀請已建立',
    revoke: '撤銷',
    revokeConfirm: '確定撤銷該邀請？',
    revokeSuccess: '邀請已撤銷',
    copy: '複製連結',
    copied: '連結已複製',
    copyFailed: '複製失敗',
    ...
    maxUses: '最大使用次數',
    maxUsesHint: '0 = 不限制',
    formHint: '0 天表示永不過期；最大使用次數 0 表示不限制。',
    statusLabel: '狀態',
    linkLabel: '邀請連結',
    status: {
      active: '有效',
  ...
  chat: {
    ...
    continueInWebUiTitle: '在網頁繼續對話？',
    continueInWebUiWarning: '系統會根據目前歷史建立獨立的網頁對話。新對話中的訊息不會傳回 {source}，{source} 中的後續訊息仍會進入原對話。',
    createWebConversation: '建立網頁對話',
    continueInWebUiFailed: '建立網頁對話失敗',
  ...
  externalIdentities: {
    title: '頻道身份映射',
    subtitle: '把飛書 / 釘釘等頻道使用者映射到 Studio 帳號。映射後，使用者可在網頁裡唯讀查看自己的頻道會話歷史。',
    mappingsTitle: '已有映射',
    candidatesTitle: '待映射候選',
    candidatesHint: '來自 Hermes 頻道會話的未映射身份，按會話數排序。綁定後該使用者即可查看對應頻道歷史。',
    refresh: '刷新',
    colSource: '頻道',
    colExternalId: '外部身份',
    colUser: '使用者',
    ...
    bind: '綁定',
    delete: '刪除',
    confirmDelete: '刪除這條映射？',
    userPlaceholder: '選擇使用者',
    emptyMappings: '暫無映射',
    emptyCandidates: '沒有待映射的候選身份',
    loadFailed: '載入失敗',
    bindSuccess: '映射已建立',
    bindFailed: '建立映射失敗',
    deleteSuccess: '映射已刪除',
  ...
  marketplace: {
    title: '插件中心',
    subtitle: '瀏覽 git 技能插件源，並將技能安裝到目前 profile',
    sourcePlaceholder: '選擇源',
    search: '搜尋插件…',
    refresh: '重新整理',
    refreshed: '插件中心已重新整理',
    addSource: '新增源',
    deleteSource: '移除源',
    deleteSourceTitle: '移除插件源',
    deleteSourceConfirm: '確定移除源「{name}」？本地快取會被刪除，已安裝的技能不受影響。',
    sourceName: '源名稱',
    sourceNamePlaceholder: '例如 hose-skills',
    sourceUrl: 'Git SSH 位址',
    sshOnlyHint: '僅支援 git SSH 位址，例如 git@git.ekuaibao.com:ai-learning/hose-skills.git',
    created: '源已新增',
    createdSyncFailed: '源已新增，但首次同步失敗：{error}',
    sourceDeleted: '源已移除',
    loadFailed: '載入插件中心失敗：{error}',
    empty: '尚未設定任何插件源。',
    emptyAdmin: '尚未設定任何插件源。新增一個 git SSH 位址即可瀏覽其中的插件。',
    noPlugins: '沒有找到插件',
    skillCount: '{n} 個技能',
    installed: '已安裝',
    installedAt: '已安裝 · 更新於 {time}',
    modified: '本地已修改',
    install: '安裝',
    installSuccess: '技能「{name}」已安裝',
    uninstall: '解除安裝',
    uninstallConfirm: '確定解除安裝技能「{name}」？該技能目錄會從目前 profile 中移除。',
    uninstallSuccess: '技能「{name}」已解除安裝',
    lastSynced: '上次同步',
    syncFailed: '上次同步失敗',
    defaultPrompt: '建議提示詞',
    pluginMissing: '該源中沒有此插件',
  },
  skills: {
    title: '技能',
    targetFilter: '執行環境',
