...
export default {
  ...
  login: {
    ...
    orDivider: 'または',
    ssoLogin: 'SSO でログイン',
    ssoFailed: 'SSO ログインに失敗しました。もう一度お試しください。',
    ssoErrors: {
      invite_unavailable: 'この招待リンクは利用できなくなりました。',
      sso_unavailable: 'このサーバーでは SSO が設定されていません。',
      sso_state_invalid: 'ログインセッションが期限切れです。もう一度お試しください。',
      sso_failed: 'SSO ログインに失敗しました。もう一度お試しください。',
      access_denied: '認証が拒否されました。',
  ...
  invite: {
    title: 'Hermes Studio に参加',
    description: 'プロフィールに招待されています',
    confirmPasswordPlaceholder: 'パスワードの確認',
    submit: 'アカウントを作成して参加',
    joinFailed: 'この招待では参加できませんでした',
    joinWithCurrentAccount: '現在のアカウントで参加',
    invalid: 'この招待リンクは無効です',
    unavailableTitle: '招待リンク利用不可',
    unavailable: 'この招待リンクは利用できません（{status}）',
    backToLogin: 'ログインに戻る',
  },

  invites: {
    title: 'プロフィール招待リンク',
    description: 'プロフィールへのアクセスを許可する招待リンクを作成します。リンクから登録したアカウントは既定のユーザーロールになります。',
    create: '招待を作成',
    createSuccess: '招待を作成しました',
    revoke: '取り消す',
    revokeConfirm: 'この招待を取り消しますか？',
    ...
    profile: 'プロフィール',
    profileRequired: 'プロフィールを選択してください',
    ...
    maxUses: '最大使用回数',
    maxUsesHint: '0 = 無制限',
    formHint: '0 日は無期限、最大使用回数 0 は無制限です。',
    statusLabel: '状態',
    linkLabel: '招待リンク',
    status: {
      active: '有効',
  ...
  chat: {
    ...
    continueInWebUiTitle: 'Web UI で続けますか？',
    continueInWebUiWarning: 'この履歴から独立した Web 会話を作成します。新しい会話のメッセージは {source} へ送信されません。{source} の新しいメッセージは元の会話に続きます。',
    createWebConversation: 'Web 会話を作成',
    continueInWebUiFailed: 'Web 会話を作成できませんでした',
