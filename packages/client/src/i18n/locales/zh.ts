...
export default {
  mcpApp: {
    loadFailed: "结果视图加载失败，可以重试或查看下方文本结果。",
  },
  ekkoConfig: {
    "settingsTitle": "设置",
    "settingsRuntime": "运行",
  ...
  login: {
    ...
    orDivider: '或',
    ssoLogin: '使用 SSO 登录',
    ssoFailed: '单点登录失败，请重试。',
    ssoErrors: {
      invite_unavailable: '该邀请已失效。',
      sso_unavailable: '服务器未配置单点登录。',
      sso_state_invalid: '登录会话已过期，请重试。',
      sso_failed: '单点登录失败，请重试。',
      access_denied: '授权被拒绝。',
      account_disabled: '你的账号已被禁用。',
    },
  ...
  invite: {
    ...
    description: '你被邀请加入配置',
    confirmPasswordPlaceholder: '确认密码',
    submit: '创建账号并加入',
    joinFailed: '加入失败',
    joinWithCurrentAccount: '使用当前账号加入',
    invalid: '邀请链接无效',
    unavailableTitle: '邀请不可用',
    unavailable: '该邀请当前不可用（{status}）',
    backToLogin: '返回登录',
  },

  invites: {
    title: '配置邀请链接',
    description: '创建可分享的邀请链接，授予某个配置的访问权限。通过链接注册的账号默认为普通用户角色。',
    create: '创建邀请',
    createSuccess: '邀请已创建',
    revoke: '撤销',
    revokeConfirm: '确定撤销该邀请？',
    revokeSuccess: '邀请已撤销',
    copy: '复制链接',
    copied: '链接已复制',
    copyFailed: '复制失败',
    ...
    maxUses: '最大使用次数',
    maxUsesHint: '0 = 不限制',
    formHint: '0 天表示永不过期；最大使用次数 0 表示不限制。',
    statusLabel: '状态',
    linkLabel: '邀请链接',
    status: {
      active: '有效',
  ...
  chat: {
    ...
    continueInWebUiTitle: '在网页继续对话？',
    continueInWebUiWarning: '系统会基于当前历史创建一个独立的网页会话。新会话中的消息不会发送回{source}，{source}中的后续消息仍进入原会话。',
    createWebConversation: '创建网页会话',
    continueInWebUiFailed: '创建网页会话失败',
  ...
  externalIdentities: {
    title: '渠道身份映射',
    subtitle: '把飞书 / 钉钉等渠道用户映射到 Studio 账号。映射后，用户可在网页里只读查看自己的渠道会话历史。',
    mappingsTitle: '已有映射',
    candidatesTitle: '待映射候选',
    candidatesHint: '来自 Hermes 渠道会话的未映射身份，按会话数排序。绑定后该用户即可查看对应渠道历史。',
    refresh: '刷新',
    colSource: '渠道',
    colExternalId: '外部身份',
    colUser: '用户',
    ...
    bind: '绑定',
    delete: '删除',
    confirmDelete: '删除这条映射？',
    userPlaceholder: '选择用户',
    emptyMappings: '暂无映射',
    emptyCandidates: '没有待映射的候选身份',
    loadFailed: '加载失败',
    bindSuccess: '映射已创建',
    bindFailed: '创建映射失败',
    deleteSuccess: '映射已删除',
  ...
  marketplace: {
    title: '插件中心',
    subtitle: '浏览 git 技能插件源，并将技能安装到当前 profile',
    ...
    deleteSourceConfirm: '确定移除源「{name}」？本地缓存会被删除，已安装的技能不受影响。',
    sourceName: '源名称',
    sourceNamePlaceholder: '例如 hose-skills',
    sourceUrl: 'Git SSH 地址',
    sshOnlyHint: '仅支持 git SSH 地址，例如 git@git.ekuaibao.com:ai-learning/hose-skills.git',
    created: '源已添加',
    createdSyncFailed: '源已添加，但首次同步失败：{error}',
    sourceDeleted: '源已移除',
    loadFailed: '加载插件中心失败：{error}',
    empty: '尚未配置任何插件源。',
    emptyAdmin: '尚未配置任何插件源。添加一个 git SSH 地址即可浏览其中的插件。',
    noPlugins: '没有找到插件',
    skillCount: '{n} 个技能',
    installed: '已安装',
    installedAt: '已安装 · 更新于 {time}',
    modified: '本地已修改',
    install: '安装',
    installSuccess: '技能「{name}」已安装',
    uninstall: '卸载',
    uninstallConfirm: '确定卸载技能「{name}」？该技能目录会从当前 profile 中移除。',
    uninstallSuccess: '技能「{name}」已卸载',
    lastSynced: '上次同步',
    syncFailed: '上次同步失败',
    defaultPrompt: '建议提示词',
    pluginMissing: '该源中没有此插件',
  },
  skills: {
    title: '技能',
    targetFilter: '运行时',
